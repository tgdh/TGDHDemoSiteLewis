...
var Carousel = (function ($) {
	...
	var _carousel = function( $carousel ) {
		...
		$carousel.each(function() {
			...
			if( count > 1 ) {
				...
				$this.slick({
					...
					prevArrow: "<button class='c-carousel__nav c-carousel__nav--prev'><i class='icon-arrow'></i><span class='u-hide-text'>Prev</span></button>",
                	nextArrow: "<button class='c-carousel__nav c-carousel__nav--next'><span class='u-hide-text'>Next</span><i class='icon-arrow'></i></button>",
				    fade: settings.fade
				});
